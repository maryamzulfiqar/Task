...
<html lang="en">
   <head>
     ...
     <meta name="description" content="Askbootstrap">
      ...
      <link href="<?php  echo base_url().'assets/vendor/icons/css/materialdesignicons.min.css';?>" rel="stylesheet" />
      ...
      <link href="<?php    echo base_url().'vendor/owl-carousel/owl.theme.css';?>" rel="stylesheet" >
   </head>
   <body>
      ...
      <!-- Owl Carousel -->
      <script href="<?php echo base_url().'assets/vendor/owl-carousel/owl.carousel.js';?>"></script>
      <!-- Custom -->
      <script href="<?php echo base_url().'js/custom.js';?>"></script>
   </body>
</html>
