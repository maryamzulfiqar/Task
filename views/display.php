<!DOCTYPE html>
   ...
   <head>
      ...
      <!-- Owl Carousel -->
      <link rel="stylesheet" href="<?php    echo base_url().'vendor/owl-carousel/owl.carousel.css';?>">
      <link rel="stylesheet" href="<?php    echo base_url().'vendor/owl-carousel/owl.theme.css';?>">
   </head>
   <body>
      ...
      <!-- Owl Carousel -->
      <script href="<?php    echo base_url().'vendor/owl-carousel/owl.carousel.js';?>"></script>
      <!-- Custom -->
